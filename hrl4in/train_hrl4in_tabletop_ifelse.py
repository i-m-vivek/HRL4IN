...
def main():
    ...
    sensor_space = train_envs.observation_space.spaces[
        "task_obs"
    ]  # changed sensor -> task_obs for matching the space of LL PPO policy. # this is a 3 dimension Box
    ...
    subgoal_mask_choices[0, :] = 1.0  # subgoal is now 3 dim rather than 6 dim
